...
class Player {
    constructor(name = 'enemy', isPlayer = false, hpMax = 100, power = 4,
        ...
        // this.addToInventory(getItem('bigClub'), 1);
        this.addToInventory(getItem('healing'), 3);
        this.addToInventory(getItem('burn'), 3);
        this.addToInventory(getItem('healingPotion'), 3);
...
Player.prototype.attack = function (target) {
    ...
    report.push(`modifier: ${modifier} Dice: ${dice} attack: ${attack} modifiedAttack: ${modifiedAttack} damage: ${damage} `);
