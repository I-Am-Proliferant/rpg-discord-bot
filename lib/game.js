...
class Game {
    ...
    getPlayer = function (userName) {
        return (this.players.find(({ name }) => name.toLowerCase().includes(userName.toLowerCase())) || false);
    };
    ...
    getPlayerFromCombat = function (userName) {
        return (this.combat.find(({ name }) => name.toLowerCase().includes(userName.toLowerCase())) || false);
    };
