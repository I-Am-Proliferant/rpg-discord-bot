...
class Game {
    ...
    getPlayer = function (userName) {
        return (this.players.find(({ name }) => name.toUpperCase() === userName.toUpperCase()) || false);
    };

    getPlayerFromCombat = function (userName) {
        return (this.combat.find(({ name }) => name.toUpperCase() === userName.toUpperCase()) || false);
    };
