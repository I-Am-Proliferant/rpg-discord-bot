...
module.exports = [
    {name: 'Normal Slime', hpMax: 10, power: 5, defense: 3, speed: 5, exp: 5, gold: 25, drops:[
        {item:getItem('healing'), chance:10},
        {item:getItem('burn'), chance:10},
        {item:getItem('token'), chance:100}
    ] },
    { name: 'Green Slime', hpMax: 10, power: 5, defense: 3, speed: 5, exp: 5, gold: 25 , drops:[
        {item:getItem('healingBand'), chance:1},
        {item:getItem('healing'), chance:75},
        {item:getItem('token'), chance:100}

    ] },
    { name: 'Blue Slime', hpMax: 10, power: 5, defense: 8, speed: 5, exp: 5, gold: 25, drops:[
        {item:getItem('buckler'), chance:10},
        {item:getItem('burn'), chance:10},
        {item:getItem('token'), chance:100}

    ]  },
    { name: 'Red Slime', hpMax: 10, power: 5, defense: 3, speed: 5, exp: 5, gold: 25, drops:[
    ...
    { name: 'Skeleton', hpMax: 10, power: 5, defense: 2, speed: 5, exp: 5, gold: 25, drops:[
        {item:getItem('sword'), chance:10},
        {item:getItem('healing'), chance:10},
        {item:getItem('token'), chance:100}

    ]  },
    { name: 'Gnoll', hpMax: 10, power: 5, defense: 5, speed: 8, exp: 5, gold: 25, drops:[
        {item:getItem('sword'), chance:10},
        {item:getItem('burn'), chance:10},
        {item:getItem('token'), chance:100}

    ]  },
    { name: 'Guardian', hpMax: 10, power: 5, defense: 15, speed: 5, exp: 5, gold: 25, drops:[
        {item:getItem('greatSword'), chance:10},
        {item:getItem('plate'), chance:10}
    ]  },
    { name: 'Dragon', hpMax: 10, power: 5, defense: 20, speed: 10, exp: 5, gold: 25, drops:[
